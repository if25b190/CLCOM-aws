...
resource "aws_vpc_security_group_egress_rule" "runner_allow_ssh_out" {
  security_group_id = aws_security_group.gitlab_runner_security.id
  cidr_ipv4 = "0.0.0.0/0"
  from_port = 22
  ip_protocol = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "runner_allow_http_out" {
  security_group_id = aws_security_group.gitlab_runner_security.id
  cidr_ipv4 = "0.0.0.0/0"
  from_port = 80
  ip_protocol = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "runner_allow_https_out" {
  security_group_id = aws_security_group.gitlab_runner_security.id
  cidr_ipv4 = "0.0.0.0/0"
  from_port = 443
  ip_protocol = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "runner_allow_dns_out" {
  security_group_id = aws_security_group.gitlab_runner_security.id
  cidr_ipv4 = "0.0.0.0/0"
  from_port = 53
  ip_protocol = "tcp"
